...
public class OSOperation_bak {
	...
	public final static String CREATE_VM_FI				= "createVmFi"; // 创建虚拟机
	/**
	 * 创建虚拟机并关联虚拟机组
	 */
	public final static String CREATE_VM_FOR_GROUP = "createVmForGroup";
	...
	public final static String GET_HOST_RES_LIST_DETAIL	= "getHostResListDetail"; // 查询主机资源详情
	 ...
	 * 获取规格磁盘详情
	 */
	public final static String GET_FLAVOR_DISK_INFO = "getFlavorDiskInfo";
	 ...
	 * 获取网络列表
	 */
	public final static String GET_NETWORK = "getNetwork";
	 ...
	 * 获取端口列表
	 */
	public final static String GET_PORT_LIST		= "getPorts";
	 ...
	 * 获取外部网络列表
	 */
	public final static String GET_EXT_NETWORK = "getExtNetwork";
	...
	public final static String DELETE_FWP			    = "deleteFwp"; // 删除防火墙策略
	...
	public final static String CREATE_VLB_LISTENER				= "createVlbListener"; //
	public final static String DELETE_VLB_LISTENER				= "deleteVlbListener"; //
	...
	public final static String PUT_PORT_IP			= "putPortIp"; // 修改端口ip
	public final static String PUT_PORT_S			= "putPortS"; // 绑定、解绑VIP

	/**
	 * 获取可用分区列表
	 */
	public final static String GET_AVAILABILITY_ZONE_LIST = "getAvailabilityZoneList";

	/**
	 * 裸机接口，8400起
	 */
	// 8400至8449是创建操作编码定义
//	public final static String PUT_VOLUME_QUOTA		= BAREMETAL; // 更新存储配额
	// 8450至8499是查询操作编码定义
	public final static String GET_BAREMETAL			= "getBaremetal"; // 查询裸机列表
	public final static String GET_BAREMETAL_DETAIL	= "getBaremetalDetail"; // 查询裸机详情
	
	/**
	 * 镜像接口，8500起
	 */
	// 8500至8549是创建操作编码定义
	public final static String CREATE_IMAGE		    = "createImage"; // 创建镜像(KVM)
	public final static String CREATE_IMAGE_PYH		= "createImagePhy"; // 创建镜像(物理机)
	public final static String CREATE_IMAGE_FUS	    = "createImageFus"; // 创建镜像(FusionCompute)
	public final static String DELETE_IMAGE				= "deleteImage"; // 删除镜像
	// 8550至8599是查询操作编码定义
	public final static String GET_IMAGE				= "getImage"; // 查询镜像
	/**
	 * 获取镜像列表
	 */
	public final static String GET_IMAGE_LIST = "getImageList";
	public final static String GET_IMAGE_LIST_NEXT = "getImageListNext";
	...
	// 8550至8599是查询操作编码定义
	public final static String GET_PHY_NET				= "getPhyNet"; // 查询物理网络
	public final static String GET_OVER_SPLIT				= "getCpuOverSplit"; // 查询超分值
	
	/**
	 * 接口，8700起
	 */
	// 8700至8749是创建操作编码定义
	public final static String CREATE_HA_STACK			= "createHAStack"; 
	// 8550至8599是查询操作编码定义
	
	/**
	 * 接口，8800起
	 */
	public final static String GET_STORAGE_VIRTUAL_POOL= "getStorageVirtualPool";
	/**
	 * 创建端口镜像服务
	 */
	public final static String CREATE_TAP_SERVICES = "createTapServices";
	/**
	 * 增加端口镜像源端口
	 */
	public final static String CREATE_TAP_FLOW = "createTapFlow";
	/**
	 * 删除端口镜像的源端口
	 */
	public final static String DELETE_TAP_FLOW = "deleteTapFlow";
	/**
	 * 删除端口镜像的模板端口
	 */
	public final static String DELETE_TAP_SERVICE = "deleteTapService";
	/**
	 * 创建虚拟机组
	 */
	public final static String CREATE_VM_GROUP = "createServerGroup";
	/**
	 * 删除虚拟机组
	 */
	public final static String DELETE_VM_GROUP = "deleteServerGroup";
	/**
	 * 查询虚拟机组详情
	 */
	public final static String GET_VM_GROUP_DETAILS = "getServerGroupDetails";
	/**
	 * 查询裸金属服务器
	 */
	public final static String GET_BUILD_BARE_METAL = "getBuildBareMetal";
}
