...
(function ($) {
    ...
    $.jBox.prompt = function (content, title, icon, options) {
        ...
        var minHeight = options.icon == 'none' ? 'height:auto;' : 'min-height:30px; line-height:25px;' + (($.browser.msie && parseInt($.browser.version) < 7) ? 'height:auto !important;height:100%;_height:30px;' : 'height:auto;');
        var html = [];
        html.push('html:');
