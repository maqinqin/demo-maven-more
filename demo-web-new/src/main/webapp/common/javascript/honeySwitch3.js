...
honeySwitch.init = function() {
	var s1 = "<span style='text-align:center' class='slider'>是</span>";
	var s2 = "<span style='text-align:center' class='slider'>否</span>";
