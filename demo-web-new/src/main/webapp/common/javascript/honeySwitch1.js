...
honeySwitch.init = function() {
	var s1 = "<span style='text-align:center' class='slider'>启用</span>";
	var s2 = "<span style='text-align:center' class='slider'>禁用</span>";
	...
	$("[class^=switch]").click(function() {
		...
		if ($(this).hasClass("switch-on")) {
			$("#du_status").val("N");
			$(this).children()[0].textContent="禁用";
			...
			$("#du_status").val("Y");
			$(this).children()[0].textContent="启用";
