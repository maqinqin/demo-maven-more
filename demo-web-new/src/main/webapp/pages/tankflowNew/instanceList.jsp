...
<head>
	<script type="text/javascript"
		src="${ctx}/pages/tankflowNew/js/instanceList.js"></script>
	<style type="text/css">
...
<body class="main1">
	<div class="content-main clear" id="searchDiv">
		<div class="page-header">
			<h1>
				<div class="WorkBtBg">流程编排/流程实例</div>
		...
		<div class="pageFormContent searchBg">
	...
	<div class="searchBtn_right" style="width:28%; float:left" >
		<table height="12%" width="100%" align="center">
			<tr style=" height:52px;">
				<td  align="left" >
						<a href="javascript:search()" onclick="search();return false; type="button" title="查询" class="btn" id="query_btn">
							<span class="icon iconfont icon-icon-search"></span>
							<span>查询</span>
						</a>
						<button type="reset" title="清空" class="btnDel" onclick="clearAll()">
