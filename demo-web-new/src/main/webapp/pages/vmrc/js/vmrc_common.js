...
VMRC_GRO.modeMask = 0;
VMRC_GRO.msgMode = 1;
VMRC_GRO.advancedConfig = '';
VMRC_GRO.connect_host = '';
VMRC_GRO.connect_thumbprint = '';
VMRC_GRO.connect_allow_ssl_errors = false;
VMRC_GRO.connect_ticket = '';
VMRC_GRO.connect_username = '';
VMRC_GRO.connect_password = '';
VMRC_GRO.connect_vmid = '';
VMRC_GRO.connect_datacenter = '';
VMRC_GRO.connect_vmpath = '';
...
function log(text)
{
   $I('msgBox').innerHTML += "<br />" + text;
   $I('msgBox').scrollTop = $I('msgBox').scrollHeight;
}
...
function startup()
{
   var modes = VMRC_GRO.modeMask;
   var msgMode = VMRC_GRO.msgMode;
   var advancedConfig = VMRC_GRO.advancedConfig;
...
function connect() {
   var host = VMRC_GRO.connect_host;
   var thumb = VMRC_GRO.connect_thumbprint.replace(/-/g, ':');
   var allowSSLErrors = VMRC_GRO.connect_allow_ssl_errors;
   var ticket = VMRC_GRO.connect_ticket;
   var user = VMRC_GRO.connect_username;
   var pass = VMRC_GRO.connect_password;
   var vmid = VMRC_GRO.connect_vmid;
   var datacenter = VMRC_GRO.connect_datacenter;
   var vmPath = VMRC_GRO.connect_vmpath;
...
function setInputRelease() {
   var release = $I('input_value').checked;
