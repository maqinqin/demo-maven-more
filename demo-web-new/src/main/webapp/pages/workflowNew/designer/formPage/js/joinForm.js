...
$(document).ready(function() {
	...
	if($('#state').val()=="design"){
		...
		nodeData = window.parent.getBaseComponentContent($('#dNodeId').val());
		//取出自定义json数据
...
function getParamOptions(){
	...
	var inner = '<option value="">'+i18nShow('compute_res_select')+'</option>';
...
function cancel(){
	window.parent.closeComponentDialog("joinComponent_div");
}