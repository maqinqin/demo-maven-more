 ...
 * @author lixiaojiang
 */
public class GetNetworkCardHandler extends OpenstackPowerVcCommonHandler {

	private static Logger logger = LoggerFactory.getLogger(GetNetworkCardHandler.class);
