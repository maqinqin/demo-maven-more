...
public class OpenstackPowerVcVRInitParam extends LocalAbstractAutomationHandler {

	private static Logger logger = LoggerFactory.getLogger(OpenstackPowerVcVRInitParam.class);
