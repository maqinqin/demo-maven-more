...
public class CheckCreateNasVolumeHandler extends RemoteAbstractAutomationHandler  {

	private static Logger logger = LoggerFactory
			.getLogger(CheckCreateNasVolumeHandler.class);
	...
	public CheckCreateNasVolumeHandler() throws Exception{
