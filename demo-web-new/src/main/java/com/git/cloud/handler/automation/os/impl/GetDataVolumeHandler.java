 ...
 */
public class GetDataVolumeHandler extends OpenstackCommonHandler {

	private static Logger logger = LoggerFactory.getLogger(GetDataVolumeHandler.class);
	...
	public void executeOperate(HashMap<String, Object> reqMap) throws Exception {
		...
		while(true) {
			...
			for(int i=0 ; i<deviceIdList.size() ; i++) {
				...
				String volumeIaasUuid = (String) deviceParams.get("DATA_VOLUME_ID");
