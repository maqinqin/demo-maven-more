...
public class CreateIGFlagFirstHandler  extends RemoteAbstractAutomationHandler {

	private static Logger log = LoggerFactory
			.getLogger(CreateIGFlagFirstHandler.class);
...
//				}
				String sn = (String) deviceInfoMap.get(StorageConstants.STORAGEONE);
				...
				for (int i = 0; i < deviceIdList.size(); i++) {
					...
					setHandleResultParam(deviceId,
							StorageConstants.STORAGEONE_IG_FLAG_FINISHED, sn);
				}
	...
	private List<String> getFCPwwnList(Map<String, Object> deviceMapInfo) throws Exception {
		Object fcpwwn = deviceMapInfo.get(StorageConstants.FA_WWNONE);
