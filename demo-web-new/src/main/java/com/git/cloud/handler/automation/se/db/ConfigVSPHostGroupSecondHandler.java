...
public class ConfigVSPHostGroupSecondHandler extends RemoteAbstractAutomationHandler{
	private static Logger log = LoggerFactory
			.getLogger(ConfigVSPHostGroupSecondHandler.class);
	...
	public String execute(HashMap<String, Object> contextParams) throws Exception {
		...
		if(contextParams!=null){
			...
			try {
				...
				String finished_flag = (String)deviceInfoMap.get("SETTING_SECOND_HOSTGROUP_FINISHED");
				...
				String sn = (String) deviceInfoMap
						.get(StorageConstants.STORAGETWO_FINISHED);
...
//				}
				...
				for (int i = 0; i < deviceIdList.size(); i++) {
					...
					setHandleResultParam(deviceId,
							"SETTING_SECOND_HOSTGROUP_FINISHED", sn);
				}
