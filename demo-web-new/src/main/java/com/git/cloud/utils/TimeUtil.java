...
public class TimeUtil {  
    ...
    public static LocalDateTime stringToLocalDateTimeBak(String dateStr, String format) {  
        try {
    ...
    /**
     * yyyyMMdd to yyyy-MM-dd 00:00:00
     * @param dateStr
     * @return
     */
    public static String yyyyMMddTo(String dateStr) {  
    	String[] s = dateStr.split("");
    	String newDate = s[0]+s[1]+s[2]+s[3]+"-"+s[4]+s[5]+"-"+s[6]+s[7]+" 00:00:00";
        return newDate;  
    }
     ...
     * @return
     */
    public static String yyyyMMddToSmall(String dateStr) {  
    	String[] s = dateStr.split(" ");
    	String[] s1 = s[1].split(":");
    	String newDate = s[0]+" "+s1[0];
        return newDate;  
    }
    /**
     * yyyyMMdd to yyyy-MM-dd 00:00:00
     ...
     * @return
     */
    public static String yyyyMMddToBig(String dateStr) {  
    	String[] s = dateStr.split(" ");
    	String[] s1 = s[1].split(":");
    	String newDate = s[0]+" "+s1[0];
    	LocalDateTime plusHours = null;
    	if(s1[1].equals("00")){
    		plusHours = stringToLocalDateTime(newDate, TimeUtil.DATE_FMT_5);
    	}else{
    		plusHours = stringToLocalDateTime(newDate, TimeUtil.DATE_FMT_5).plusHours(1);
    	}
        return formatLocalDateTimeToString(plusHours,TimeUtil.DATE_FMT_5); 
    }
    
    /**
     * 2017-02-01 09:45:00 to 2017-02-01 09:00:00
     * @param dateStr
     * @return
     */
//    public static String yyyyMMddToSmall(String dateStr) {  
//    	LocalDateTime localDateTime = stringToLocalDateTime(dateStr, TimeUtil.TIME_PATTERN);
//    	String[] s = dateStr.split(" ");
//    	String[] s1 = s[1].split(":");
//    	int min = Integer.parseInt(s1[1]);
//    	int sec = Integer.parseInt(s1[2]);
//    	LocalDateTime minu = localDateTime.minusMinutes(min);
//    	minu = minu.minusSeconds(sec);
//        return formatLocalDateTimeToString(minu,TimeUtil.TIME_PATTERN);
//    }
    /**
     * 2017-02-01 09:45:00 to 2017-02-01 10:00:00
     * @param dateStr
     * @return
     */
    public static String yyyyMMddToBig1(String dateStr) {  
    	LocalDateTime localDateTime = stringToLocalDateTime(dateStr, TimeUtil.TIME_PATTERN);
    	String[] s = dateStr.split(" ");
    	String[] s1 = s[1].split(":");
    	int min = 60-Integer.parseInt(s1[1]);
    	int sec = 60-Integer.parseInt(s1[2]);
    	LocalDateTime plus = localDateTime.plusSeconds(sec).plusMinutes(min);
        return formatLocalDateTimeToString(plus,TimeUtil.TIME_PATTERN);  
    }
...
//    	String[] s2 = s[0].split("-");
//    	String newDate = "";
//    	newDate = s[0]+" "+(Integer.parseInt(s1[0])+1)+":"+"00"+":"+"00";
//        return newDate;  
//    }
...
//		int compareTwoTime = TimeUtil.compareTwoTime(now, TimeUtil.stringToLocalDateTime("2018-03-16 00:00:00", TimeUtil.TIME_PATTERN));
//		System.out.println(compareTwoTime);
//		String nowStr = formatLocalDateTimeToString(now,TimeUtil.TIME_PATTERN);
//		System.out.println(nowStr);
//		nowStr = TimeUtil.yyyyMMddToBig(nowStr);
//		System.out.println(nowStr);
    	//1521367306000
    	long l = Long.parseLong("1521367306000");
    	Date date =new Date(l);
    	System.out.println(date);
    	String dateStr = dateToLocalDateTime(date).toString();
    	System.out.println(dateStr);
    	System.out.println(formatLocalDateTimeToString(dateToLocalDateTime(date),TIME_PATTERN));
    }
     ...
     * @return
     */
    public static String longToStr(long longStr,String pattern){
    	Date date =new Date(longStr);
    	String formatLocalDateTimeToString = formatLocalDateTimeToString(dateToLocalDateTime(date),pattern);
    	return formatLocalDateTimeToString;
    }
