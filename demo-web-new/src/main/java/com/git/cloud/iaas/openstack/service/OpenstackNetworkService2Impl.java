...
public class OpenstackNetworkService2Impl extends OpenstackNetworkServiceAbstractImpl implements OpenstackNetworkService {
	...
	public String getPhyNet(OpenstackIdentityModel model) throws Exception {
		...
		String result = "";
		IDataObject reqData = this.getIDataObject(OSOperation_bak.GET_PHY_NET+model.getVersion().replace(".", ""),model.getOpenstackIp(),model.getDomainName(),model.getToken());
