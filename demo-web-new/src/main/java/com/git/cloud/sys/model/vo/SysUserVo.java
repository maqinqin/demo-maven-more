...
public class SysUserVo   extends BaseBO implements Serializable {
	...
	public SysUserVo(String userId, String orgId, String orgName, String firstName, String lastName, String loginName,
			String loginPassword, String email, String phone, String ipAddress, String lastLogin, String userType,
			String userTypeName, String isActive, String platUser) {
		super();
		this.userId = userId;
		this.orgId = orgId;
